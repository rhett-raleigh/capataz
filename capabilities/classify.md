...
2. Ask: does resolving this end in a **code change to a known repo**? If yes →
   engineering. If it's actionable but not code → task. If it's for *you* to
   reflect on or recall later → note.
